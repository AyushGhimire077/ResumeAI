...
const generateResumePrompt = (userInfo) => {
    return `
...
const giveResponse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const model = openaiConfig_1.googleAI.getGenerativeModel({ model: "gemini-1.5-flash" });
        const result = yield model.generateContent(resumePrompt);
        let generatedResume = yield result.response.text();
